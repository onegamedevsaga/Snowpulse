...
bool DirectoryIOS::CreateDirectory(std::string path) {
...
std::string DirectoryIOS::GetApplicationSupportPath(std::string filename) {
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSApplicationSupportDirectory, NSUserDomainMask, YES);
    return GetWritablePath(filename, [[paths firstObject] UTF8String]);
}

std::string DirectoryIOS::GetDocumentsPath(std::string filename) {
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    return GetWritablePath(filename, [[paths firstObject] UTF8String]);
}

std::string DirectoryIOS::GetResourcesPath(std::string filename) {
...
std::string DirectoryIOS::GetWritablePath(std::string filename, std::string directory) {
